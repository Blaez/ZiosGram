...
static const char *FileLoadOperationClassPathName = "org/ZiosGram/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/ZiosGram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/ZiosGram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/ZiosGram/tgnet/RequestDelegateInternal;Lorg/ZiosGram/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/ZiosGram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ZiosGram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ZiosGram/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/ZiosGram/tgnet/ConnectionsManager"));
