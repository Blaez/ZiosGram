 ...
 */
package org.blaez.ziosgram.exoplayer2;
...
import org.blaez.ziosgram.exoplayer2.audio.AudioCapabilities;
import org.blaez.ziosgram.exoplayer2.audio.AudioRendererEventListener;
import org.blaez.ziosgram.exoplayer2.audio.AudioTrack;
import org.blaez.ziosgram.exoplayer2.audio.MediaCodecAudioRenderer;
import org.blaez.ziosgram.exoplayer2.decoder.DecoderCounters;
import org.blaez.ziosgram.exoplayer2.drm.DrmSessionManager;
import org.blaez.ziosgram.exoplayer2.drm.FrameworkMediaCrypto;
import org.blaez.ziosgram.exoplayer2.mediacodec.MediaCodecSelector;
import org.blaez.ziosgram.exoplayer2.metadata.Metadata;
import org.blaez.ziosgram.exoplayer2.metadata.MetadataRenderer;
import org.blaez.ziosgram.exoplayer2.metadata.id3.Id3Decoder;
import org.blaez.ziosgram.exoplayer2.source.MediaSource;
import org.blaez.ziosgram.exoplayer2.source.TrackGroupArray;
import org.blaez.ziosgram.exoplayer2.text.Cue;
import org.blaez.ziosgram.exoplayer2.text.TextRenderer;
import org.blaez.ziosgram.exoplayer2.trackselection.TrackSelectionArray;
import org.blaez.ziosgram.exoplayer2.trackselection.TrackSelector;
import org.blaez.ziosgram.exoplayer2.video.MediaCodecVideoRenderer;
import org.blaez.ziosgram.exoplayer2.video.VideoRendererEventListener;
...
public class SimpleExoPlayer implements ExoPlayer {
  ...
  protected void buildVideoRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("org.blaez.ziosgram.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("org.blaez.ziosgram.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("org.blaez.ziosgram.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
    ...
    try {
      Class<?> clazz =
          Class.forName("org.blaez.ziosgram.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
