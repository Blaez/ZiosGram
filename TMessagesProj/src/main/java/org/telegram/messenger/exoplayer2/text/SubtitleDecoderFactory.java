...
import org.blaez.ziosgram.exoplayer2.text.cea.Cea608Decoder;
import org.blaez.ziosgram.exoplayer2.text.subrip.SubripDecoder;
import org.blaez.ziosgram.exoplayer2.text.ttml.TtmlDecoder;
import org.blaez.ziosgram.exoplayer2.text.tx3g.Tx3gDecoder;
import org.blaez.ziosgram.exoplayer2.text.webvtt.Mp4WebvttDecoder;
import org.blaez.ziosgram.exoplayer2.text.webvtt.WebvttDecoder;
      ...
      try {
        switch (mimeType) {
          case MimeTypes.TEXT_VTT:
            return Class.forName("org.blaez.ziosgram.exoplayer2.text.webvtt.WebvttDecoder");
          case MimeTypes.APPLICATION_TTML:
            return Class.forName("org.blaez.ziosgram.exoplayer2.text.ttml.TtmlDecoder");
          case MimeTypes.APPLICATION_MP4VTT:
            return Class.forName("org.blaez.ziosgram.exoplayer2.text.webvtt.Mp4WebvttDecoder");
          case MimeTypes.APPLICATION_SUBRIP:
            return Class.forName("org.blaez.ziosgram.exoplayer2.text.subrip.SubripDecoder");
          case MimeTypes.APPLICATION_TX3G:
            return Class.forName("org.blaez.ziosgram.exoplayer2.text.tx3g.Tx3gDecoder");
          case MimeTypes.APPLICATION_CEA608:
            return Class.forName("org.blaez.ziosgram.exoplayer2.text.cea.Cea608Decoder");
          default:
            return null;
        }
