...
import org.blaez.tgnet.SerializedData;
...
import org.blaez.ui.Cells.TextInfoCell;
import org.blaez.ui.Cells.EmptyCell;
import org.blaez.ui.Cells.HeaderCell;
import org.blaez.ui.Cells.ShadowSectionCell;
import org.blaez.ui.Cells.TextCheckCell;
import org.blaez.ui.Cells.TextDetailSettingsCell;
import org.blaez.ui.Cells.TextSettingsCell;
...
import org.blaez.ui.Components.AvatarUpdater;
...
import org.blaez.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == ZiosGramFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("ZiosGramFaqUrl", R.string.ZiosGramFaqUrl));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("ZiosGramFAQ", R.string.ZiosGramFaq), true);
                    } else if (position == contactsReimportRow) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == enableAnimationsRow || position == notificationRow || position == backgroundRow || position == numberRow ||
                    ...
                    position == switchBackendButtonRow || position == ZiosGramFaqRow || position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("ZiosGramVersion", R.string.ZiosGramVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi)));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
