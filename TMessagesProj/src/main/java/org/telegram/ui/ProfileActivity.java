...
import org.blaez.ui.Cells.AboutLinkCell;
import org.blaez.ui.Cells.DividerCell;
import org.blaez.ui.Cells.EmptyCell;
import org.blaez.ui.Cells.LoadingCell;
import org.blaez.ui.Cells.ShadowSectionCell;
import org.blaez.ui.Cells.TextCell;
import org.blaez.ui.Cells.TextDetailCell;
import org.blaez.ui.Cells.TextInfoPrivacyCell;
import org.blaez.ui.Cells.UserCell;
...
import org.blaez.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (MessagesController.getInstance().callsEnabled && userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaZiosGram", R.string.CallViaZiosGram));
                actions.add(2);
            }
